    ...
    <div className="flex flex-col gap-8 mx-auto w-full max-w-6xl text-gray-900 dark:text-gray-100 pb-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-start">
        ...
        <div className="w-full md:w-64 flex flex-col gap-2 bg-white dark:bg-zinc-900 p-4 rounded-[20px] border border-gray-100 dark:border-zinc-800 shrink-0">
          ...
          <div className="flex-1 mt-4 border-t border-gray-100 dark:border-zinc-800 pt-4">
            <button
              onClick={handleLogout}
              disabled={isLoggingOut}
              className="flex items-center gap-3 px-4 py-3 w-full rounded-xl transition-all duration-200 font-medium text-[15px] text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isLoggingOut ? (
